                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        @php
                            $menuItems = [
                                ...
                                ['label' => 'Voucher', 'icon' => 'ri-coupon-3-line', 'route' => 'backend.vouchers.index'],
